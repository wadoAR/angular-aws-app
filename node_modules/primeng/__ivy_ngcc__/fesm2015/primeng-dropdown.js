...
function Dropdown_div_11_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Dropdown_div_11_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); return $event.stopPropagation(); });
    ɵngcc0.ɵɵelementStart(2, "input", 28, 29);
    ɵngcc0.ɵɵlistener("keydown.enter", function Dropdown_div_11_div_2_Template_input_keydown_enter_2_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); return $event.preventDefault(); })("keydown", function Dropdown_div_11_div_2_Template_input_keydown_2_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); const ctx_r30 = ɵngcc0.ɵɵnextContext(2); return ctx_r30.onKeydown($event, false); })("input", function Dropdown_div_11_div_2_Template_input_input_2_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); const ctx_r31 = ɵngcc0.ɵɵnextContext(2); return ctx_r31.onFilterInputChange($event); });
    ɵngcc0.ɵɵelementEnd();
